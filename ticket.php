...
<body>
    <div class="ticket-container">
        <?php
            ...
            } elseif ($bookingApprovalStatus === 'pending') {
                if ($paymentStatus === 'paid') {
                    echo '<div class="success-message"> Payment successful! Your ticket is pending approval.</div>';
                } else {
                    echo '<div class="success-message warning"> Your booking is pending. Please complete payment.</div>';
                }
        ...
        <div class="ticket-content">
            ...
            <div class="qr-section">
                <div class="qr-pending">
                    ...
                    <p>Your QR code will be available once your booking is approved by our staff.</p>
                    <?php if ($paymentStatus === 'paid'): ?>
                    <p>Your payment has been received. Please wait for admin approval.</p>
                    <?php else: ?>
                    <p>Please complete your payment to proceed with booking approval.</p>
                    <?php endif; ?>
                </div>
            </div>
            <?php endif; ?>
